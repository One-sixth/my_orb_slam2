...
namespace ORB_SLAM2
{
	...
	Sim3Solver::Sim3Solver(Map *pMap, KeyFrame *pKF1, KeyFrame *pKF2, const vector<MapPoint*> &vpMatched12, const bool bFixScale) :
		mpMap(pMap), mnIterations(0), mnBestInliers(0), mbFixScale(bFixScale)
	{
		mpKF1 = pKF1;
		mpKF2 = pKF2;
		...
		for (int i1 = 0; i1 < mN1; i1++)
		{
			if (vpMatched12[i1])
			{
				...
				if (MapPoint::isBad(pMP1, mpMap) || MapPoint::isBad(pMP2, mpMap))
					continue;
