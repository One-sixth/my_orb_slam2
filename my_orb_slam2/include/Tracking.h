...
namespace ORB_SLAM2
{
	...
	{
	public:
		Tracking(System *pSys, ORBVocabulary *pVoc, GlobalData *pGlobalData, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Map *pMap,
		...
		// 用于加载地图后的设定
		void SettingAfterLoadMap(KeyFrame *pReferenceKF);
	...
	public:
		...
		// Use for fps show
		chrono::milliseconds mLastClearTime = chrono::duration_cast<chrono::milliseconds>(chrono::steady_clock::now().time_since_epoch());
